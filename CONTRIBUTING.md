# Contributing to <armor-checkers>
...
1. [Fork](https://github.com/qualcomm/armor-checkers/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qualcomm/armor-checkers.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/armor-checkers.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/armor-checkers/pulls) from your branch to `main`.
...
- Follow the existing style where possible. e.g. PEP8 for python , https://peps.python.org/pep-0008/
- Write tests.
